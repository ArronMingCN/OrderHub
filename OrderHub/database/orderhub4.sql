...
INSERT INTO `askorders` VALUES ('15', '3', 'AAPL', 'LMT', '1', '121', '121', '1021.21', '0', '2018-08-13 13:44:54');
...
INSERT INTO `bidorders` VALUES ('16', '3', 'AAPL', 'LMT', '1', '100', '100', '1020.20', '0', '2018-08-13 16:51:27');

-- ----------------------------
-- Table structure for matchedorders
-- ----------------------------
DROP TABLE IF EXISTS `matchedorders`;
CREATE TABLE `matchedorders` (
  `TiketID` int(10) NOT NULL AUTO_INCREMENT,
  `OrderID1` int(10) NOT NULL,
  `OrderID2` int(10) NOT NULL,
...
askorders
WHERE
OrderType != "MKT" and Status = 1 ;

-- ----------------------------
-- View structure for bidorderbook
-- ----------------------------
DROP VIEW IF EXISTS `bidorderbook`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `bidorderbook` AS SELECT
bidorders.OrderID,
bidorders.UserID,
bidorders.Symbol,
bidorders.Remainder,
